...
export default function TargetModal({
  ...
  return (
    <div className="fixed inset-0 z-30 bg-black/60 flex items-end sm:items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="target-modal-title">
      <div className="w-full max-w-sm rounded-2xl bg-slate-800 p-5 space-y-3">
        <h2 id="target-modal-title" className="font-bold text-lg">{TITLE[pending.type]}</h2>
